...
export const fetchTracingConfig: Fetcher<TracingConfig & { has_not_configured: true }, { appId: string; provider: any }> = ({ appId, provider }) => {
...
export const removeTracingConfig: Fetcher<CommonResponse, { appId: string; provider: any }> = ({ appId, provider }) => {
